...
typedef struct _DDSURFACEDESC2
{
    ...
    {
        DDPIXELFORMAT   ddpfPixelFormat;        // pixel format description of the surface
        DWORD           dwFVF;                  // vIndex format description of vIndex buffers
    } DUMMYUNIONNAMEN(4);
...
/*
 * Indicates that the vIndex buffer data can be used to render points and
 * point sprites.
 */
#define DDSCAPS2_POINTS                         0x00800000L

/*
 * Indicates that the vIndex buffer data can be used to render rt pactches.
 */
#define DDSCAPS2_RTPATCHES                      0x01000000L

/*
 * Indicates that the vIndex buffer data can be used to render n patches.
 */
 ...
 * lock. This can be useful when one is only appending data to the vIndex
 * buffer
 */
 ...
 * surface or vIndex buffer during this lock.
 * This enables two things:
 * -    Direct3D or the driver may provide an alternative memory
 *      area as the vIndex buffer. This is useful when one plans to clear the
 *      contents of the vIndex buffer and fill in new data.
